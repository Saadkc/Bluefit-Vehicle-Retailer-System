...
class OnlineExamReportCubit extends Cubit<OnlineExamReportState> {
  ...
  void getExamOnlineReport({
    ...
    try {
      ...
      emit(OnlineExamReportFetchSuccess(
        examList: examList,
        attempted: attempted,
        missedExams: missedExams,
        totalObtainedMarks: totalObtainedMarks,
  ...
  void getMoreExamOnlineReport({
    ...
    if (state is OnlineExamReportFetchSuccess) {
      ...
      try {
        emit((state as OnlineExamReportFetchSuccess)
        ...
        emit((state as OnlineExamReportFetchSuccess).copyWith(
